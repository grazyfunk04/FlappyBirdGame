...
def mainGame():
    ...
    while True:
        ...
        #Add a new pipe when the first pipe is about to go to left
...
if __name__ == "__main__":
    #this will be the main point where a game willl start
    pygame.init() #initialise all pygame modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird By Kunal')
